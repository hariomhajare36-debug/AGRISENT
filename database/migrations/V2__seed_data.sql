...
BEGIN
    ...
    VALUES 
    ('admin', 'admin@agrirent.com', '$2a$10$aokAiZjgPq7kZ9blLI4BsOanLVDw9FL19wUN1jw9lIJ5g8yt8EkqO', 'Sarah Jenkins', 'ROLE_ADMIN', 'AgriRent Operations HQ', '(515) 555-0199', '100 Gateway Blvd', 'Des Moines', 'IA', '50309', 1),
    ('marcus_vance', 'marcus@cedarvalley.com', '$2a$10$aokAiZjgPq7kZ9blLI4BsOanLVDw9FL19wUN1jw9lIJ5g8yt8EkqO', 'Marcus Vance', 'ROLE_OWNER', 'Cedar Valley Farms & Agri-Fleet', '(319) 555-0142', '4580 Prairie View Rd', 'Cedar Rapids', 'IA', '52404', 1),
    ('david_miller', 'david.miller@farmmail.com', '$2a$10$aokAiZjgPq7kZ9blLI4BsOanLVDw9FL19wUN1jw9lIJ5g8yt8EkqO', 'David Miller', 'ROLE_FARMER', 'Miller Family Grain & Row-Crop', '(515) 555-0177', '1240 Harvest Way', 'Ames', 'IA', '50010', 1),
    ('elena_rostova', 'elena@midwestag.com', '$2a$10$aokAiZjgPq7kZ9blLI4BsOanLVDw9FL19wUN1jw9lIJ5g8yt8EkqO', 'Elena Rostova', 'ROLE_OWNER', 'Heartland Fleet Solutions', '(641) 555-0188', '890 Cornhusker Trail', 'Marshalltown', 'IA', '50158', 1);
END;
